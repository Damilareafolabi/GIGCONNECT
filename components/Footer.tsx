...
interface FooterProps {
    ...
    onNavigatePublic?: (view: 'terms' | 'privacy' | 'contact' | 'blog' | 'safety') => void;
}
            ...
            <div className="container mx-auto max-w-lg">
                ...
                <div className="mt-6 border-t border-gray-300 dark:border-gray-700 pt-4">
                    <div className="flex flex-wrap justify-center gap-4 text-xs text-gray-600 dark:text-gray-400 mb-3">
                        ...
                        <button onClick={() => (navigate ? navigate('safety') : onNavigatePublic?.('safety'))} className="hover:underline">Safety</button>
